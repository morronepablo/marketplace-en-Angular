      ...
      this.arrayTitleList.forEach(titleList => {
        ...
        for(let i = 0; i < titleList.length; i++) {
          ...
          .subscribe(resp => {
            ...
            /*==================================================
            Hacemos un recorrido por la colección general de sub-categorias
            ==================================================*/
            ...
            for(f in arraySubCategories) {
              ...
              /*==================================================
              Hacemos un recorrido por la colección particular de sub-categorias
              ==================================================*/

              for(g in arraySubCategories[f]) {

                /*==================================================
                Creamos un nuevo array de objetos clasificando cada subcategorias con la respectiva lista de titulos a la que pertenece
                ==================================================*/
            ...
            for(f in arrayTitleName) {
              ...
              if(titleList[i] == arrayTitleName[f].titleList) {
                ...
                /*==================================================
                Imprimir el nombre de subcategoría debajo del listado correspondiente
                ==================================================*/
