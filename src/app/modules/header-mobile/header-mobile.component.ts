    ...
    if(this.render) {
      ...
      this.categoriesList.forEach(category => {
        ...
        .subscribe(resp => {
          ...
          /*==================================================
          Hacemos un recorrido por la colección general de sub-categorias y
          clasificamos de acuerdo a la categoría que correspondan
          ==================================================*/
          ...
          /*==================================================
          Recorremos el array de objetos nuevo para buscar coincidencias con las nombresde categorías
          ==================================================*/
